    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Welcome back{user?.name ? `, ${user.name}` : ''}! Manage your branch operations from here.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Manage your branch staff, services, and customer inquiries efficiently.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Service Management */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Service Management</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-sm font-bold text-purple-600">Healthcare</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">John Doe joined as Customer Service Representative</p>
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Healthcare service information updated</p>
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Inquiry resolved</p>
              <p className="text-sm text-gray-600">Customer inquiry about loan services resolved</p>
