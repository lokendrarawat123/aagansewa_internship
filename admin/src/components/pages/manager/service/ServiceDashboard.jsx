...
const ManagerServiceDashboard = () => {
  ...
  // Filter services for manager's branch only
  const allServices = servicesData?.allServices || servicesData?.services || [];
  const branchServices = allServices.filter(service => service.branch_id == userBranchId);
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append("branch_id", userBranchId); // Auto-assign to manager's branch
      ...
      <div className="flex justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Managing services for {userBranch?.branch_name || `Branch ${userBranchId}`}
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xl font-bold text-gray-900">{branchServices.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-600">Popular Service</p>
              <p className="text-sm font-bold text-gray-900">
                {branchServices.length > 0 ? branchServices[0].service_name : "None"}
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleAddSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              disabled
            />
            <p className="text-xs text-gray-500 mt-1">Service will be added to your branch</p>
          </div>
...
export default ManagerServiceDashboard;